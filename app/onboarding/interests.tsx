...
const interestCategories = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'go-fishing', label: 'go fishing' },
      { id: 'go-kayaking', label: 'go kayaking' },
      { id: 'splitboarding', label: 'splitboarding' },
...
{ id: 'do-karaoke', label: 'do karaoke' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'hammocking', label: 'hammocking' },
      { id: 'campfire-hangs', label: 'campfire hangs' },
